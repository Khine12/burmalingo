...
const LISTENING_LEVELS: { id: ListeningLevel; label: string }[] = [
...
export default function ListeningPage() {
  ...
  useEffect(() => {
    if (!user) return
    listeningApi.listAudios()
      .then(res => { setAudios(res.data); setLoading(false) })
      ...
      <div className="max-w-2xl mx-auto px-6 py-4 flex items-center gap-4">
        {showBack && (
          <button
            ...
            aria-label="Back to IELTS preparation"
          >
  ...
  return (
    <div className="min-h-screen bg-cream font-sans">
      ...
      <main className="max-w-2xl mx-auto px-6 py-8 space-y-8">
        <div>
          <h1 className="font-serif text-2xl font-bold text-bark">IELTS Listening</h1>
