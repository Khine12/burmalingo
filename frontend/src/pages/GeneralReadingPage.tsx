    ...
    <div className="min-h-screen bg-cream font-sans">
      ...
      {phase === 'list' && (
        <main className="max-w-5xl mx-auto px-6 py-10 space-y-8">
          <div>
            <h1 className="font-serif text-3xl font-bold text-bark">General Reading</h1>
          ...
          {filtered.length === 0 ? (
            <p className="text-bark-light text-sm">No passages available at this level yet.</p>
          ) : (
        ...
        <main className="max-w-5xl mx-auto px-6 py-8 space-y-8 lg:grid lg:grid-cols-[1fr_420px] lg:gap-8 lg:space-y-0 lg:items-start">
          ...
          <div className="lg:sticky lg:top-[73px]">
            <div className="bg-white rounded-2xl border border-bark/10 shadow-sm overflow-hidden">
              <div className="border-b border-bark/8 px-6 py-4">
  ...
  return (
    <div className="bg-white rounded-2xl border border-bark/10 shadow-sm px-5 py-5 space-y-4">
      ...
      <div className="ml-9">
        ...
        {/* Multiple choice or vocab — same rendering */}
        {(q.type === 'multiple' || q.type === 'vocab') && q.options && (
