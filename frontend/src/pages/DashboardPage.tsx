...
const categories = [
  ...
  { icon: '✍️', title: 'General Writing',          desc: 'Writing by level',             href: '/writing-general',bg: '#7c2d12', text: '#ffffff' },
  { icon: '🎧', title: 'General Listening',        desc: 'Dialogues by level',           href: '/listening-general',bg: '#0f766e', text: '#ffffff' },
