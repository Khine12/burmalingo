  ...
  return (
    <div className="relative overflow-hidden text-center px-7 py-24" style={{background:'linear-gradient(165deg,#0D2B1E 0%,#1B4332 60%,#163827 100%)'}}>
      ...
      <p className="text-white/65 text-sm max-w-lg mx-auto mb-9 leading-relaxed">
        Grammar explained in Burmese. Spaced repetition vocabulary. AI writing, speaking, and listening feedback — built by a Burmese immigrant who studied English before arriving in the US, and learned what real-world fluency actually takes after 3 years of living it.
      </p>
      <div className="flex gap-2.5 justify-center flex-wrap">
        <a href="/register" className="bg-yellow-600 text-white font-bold px-7 py-4 rounded-lg text-base hover:-translate-y-0.5 transition-transform">Try It Free →</a>
